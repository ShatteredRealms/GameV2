...
class GrpcContext_ChatService_SetUserChatChannelAuthorizations : public GrpcContext_Ping_Pong<ChatService_SetUserChatChannelAuthorizations_ReaderWriter, ::google::protobuf::Empty>
{
	friend class UChatServiceClient;
	typedef GrpcContext_Ping_Pong<ChatService_SetUserChatChannelAuthorizations_ReaderWriter, ::google::protobuf::Empty> Super;

private:
	void Call(const FGrpcSroChatRequestSetChannelAuth& Request);
	virtual void OnRpcEvent(bool Ok, const void* EventTag) override;

public:
	GrpcContext_ChatService_SetUserChatChannelAuthorizations(FGrpcContextHandle _Handle, UGrpcService* _Service, UGrpcClient* _Client);
};

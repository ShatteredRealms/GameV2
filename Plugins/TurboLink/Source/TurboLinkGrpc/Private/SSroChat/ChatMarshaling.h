...
void GRPC_TO_TURBOLINK(const ::sro::chat::RequestSetChannelAuth* in, FGrpcSroChatRequestSetChannelAuth* out);
void TURBOLINK_TO_GRPC(const FGrpcSroChatRequestSetChannelAuth* in, ::sro::chat::RequestSetChannelAuth* out);
...
typedef grpc::ClientAsyncResponseReader<::google::protobuf::Empty> ChatService_SetUserChatChannelAuthorizations_ReaderWriter;

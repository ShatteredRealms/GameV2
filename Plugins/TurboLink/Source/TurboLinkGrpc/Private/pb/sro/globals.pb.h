...
template <>
::sro::UserTarget* Arena::CreateMaybeMessage<::sro::UserTarget>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class UserTarget final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR UserTarget(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const UserTarget& from) {
    UserTarget::MergeImpl(*this, from);
  }
  private:
...
inline PROTOBUF_ALWAYS_INLINE void UserTarget::set_id(Arg_&& arg,
                                                     Args_... args) {
  if (target_case() != kId) {
    clear_target();

    set_has_id();
    _impl_.target_.id_.InitDefault();
  }
  _impl_.target_.id_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline void UserTarget::_internal_set_id(const std::string& value) {
  ...
  _impl_.target_.id_.Set(value, GetArenaForAllocation());
}
inline std::string* UserTarget::_internal_mutable_id() {
  ...
  return _impl_.target_.id_.Mutable( GetArenaForAllocation());
}
inline std::string* UserTarget::release_id() {
  ...
  clear_has_target();
  return _impl_.target_.id_.Release();
}
inline void UserTarget::set_allocated_id(std::string* value) {
  if (has_target()) {
    clear_target();
  }
  if (value != nullptr) {
    set_has_id();
    _impl_.target_.id_.InitAllocated(value, GetArenaForAllocation());
  }
...
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void UserTarget::set_username(Arg_&& arg,
                                                     Args_... args) {
  if (target_case() != kUsername) {
    clear_target();

    set_has_username();
    _impl_.target_.username_.InitDefault();
  }
  _impl_.target_.username_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline const std::string& UserTarget::_internal_username() const {
  ...
  return _impl_.target_.username_.Get();
}
inline void UserTarget::_internal_set_username(const std::string& value) {
  ...
  _impl_.target_.username_.Set(value, GetArenaForAllocation());
}
inline std::string* UserTarget::_internal_mutable_username() {
  ...
  return _impl_.target_.username_.Mutable( GetArenaForAllocation());
}
inline std::string* UserTarget::release_username() {
  ...
  clear_has_target();
  return _impl_.target_.username_.Release();
}
inline void UserTarget::set_allocated_username(std::string* value) {
  if (has_target()) {
    clear_target();
  }
  if (value != nullptr) {
    set_has_username();
    _impl_.target_.username_.InitAllocated(value, GetArenaForAllocation());
  }
...
inline UserTarget::TargetCase UserTarget::target_case() const {
  return UserTarget::TargetCase(_impl_._oneof_case_[0]);
}
// -------------------------------------------------------------------

...
#ifndef GOOGLE_PROTOBUF_INCLUDED_sro_2fgamebackend_2fconnection_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_sro_2fgamebackend_2fconnection_2eproto_2epb_2eh
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable
    descriptor_table_sro_2fgamebackend_2fconnection_2eproto;
namespace sro {
...
PROTOBUF_NAMESPACE_OPEN
template <>
::sro::gamebackend::ConnectGameServerResponse* Arena::CreateMaybeMessage<::sro::gamebackend::ConnectGameServerResponse>(Arena*);
template <>
::sro::gamebackend::ConnectionStatus* Arena::CreateMaybeMessage<::sro::gamebackend::ConnectionStatus>(Arena*);
template <>
::sro::gamebackend::TransferPlayerRequest* Arena::CreateMaybeMessage<::sro::gamebackend::TransferPlayerRequest>(Arena*);
template <>
::sro::gamebackend::VerifyConnectRequest* Arena::CreateMaybeMessage<::sro::gamebackend::VerifyConnectRequest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class VerifyConnectRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:sro.gamebackend.VerifyConnectRequest) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "sro.gamebackend.VerifyConnectRequest";
  }
  protected:
  ...
  public:
  // @@protoc_insertion_point(class_scope:sro.gamebackend.VerifyConnectRequest)
 private:
  class _Internal;
...
class ConnectionStatus final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:sro.gamebackend.ConnectionStatus) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "sro.gamebackend.ConnectionStatus";
  }
  protected:
  ...
  public:
  // @@protoc_insertion_point(class_scope:sro.gamebackend.ConnectionStatus)
 private:
  class _Internal;
...
class TransferPlayerRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:sro.gamebackend.TransferPlayerRequest) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "sro.gamebackend.TransferPlayerRequest";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:sro.gamebackend.TransferPlayerRequest)
 private:
  class _Internal;
...
inline const std::string& ConnectGameServerResponse::connection_id() const {
  // @@protoc_insertion_point(field_get:sro.gamebackend.ConnectGameServerResponse.connection_id)
...
inline PROTOBUF_ALWAYS_INLINE void ConnectGameServerResponse::set_connection_id(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:sro.gamebackend.ConnectGameServerResponse.connection_id)
}
inline std::string* ConnectGameServerResponse::mutable_connection_id() {
  std::string* _s = _internal_mutable_connection_id();
  // @@protoc_insertion_point(field_mutable:sro.gamebackend.ConnectGameServerResponse.connection_id)
  return _s;
}
...
inline std::string* ConnectGameServerResponse::release_connection_id() {
  // @@protoc_insertion_point(field_release:sro.gamebackend.ConnectGameServerResponse.connection_id)
...
inline void ConnectGameServerResponse::set_allocated_connection_id(std::string* value) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:sro.gamebackend.ConnectGameServerResponse.connection_id)
}
...
inline const std::string& VerifyConnectRequest::connection_id() const {
  // @@protoc_insertion_point(field_get:sro.gamebackend.VerifyConnectRequest.connection_id)
  return _internal_connection_id();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void VerifyConnectRequest::set_connection_id(Arg_&& arg,
  ...
  ;
  _impl_.connection_id_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:sro.gamebackend.VerifyConnectRequest.connection_id)
}
inline std::string* VerifyConnectRequest::mutable_connection_id() {
  std::string* _s = _internal_mutable_connection_id();
  // @@protoc_insertion_point(field_mutable:sro.gamebackend.VerifyConnectRequest.connection_id)
  return _s;
}
...
inline std::string* VerifyConnectRequest::release_connection_id() {
  // @@protoc_insertion_point(field_release:sro.gamebackend.VerifyConnectRequest.connection_id)
  return _impl_.connection_id_.Release();
}
inline void VerifyConnectRequest::set_allocated_connection_id(std::string* value) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:sro.gamebackend.VerifyConnectRequest.connection_id)
}
...
inline const std::string& VerifyConnectRequest::server_name() const {
  // @@protoc_insertion_point(field_get:sro.gamebackend.VerifyConnectRequest.server_name)
...
inline PROTOBUF_ALWAYS_INLINE void VerifyConnectRequest::set_server_name(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:sro.gamebackend.VerifyConnectRequest.server_name)
}
inline std::string* VerifyConnectRequest::mutable_server_name() {
  std::string* _s = _internal_mutable_server_name();
  // @@protoc_insertion_point(field_mutable:sro.gamebackend.VerifyConnectRequest.server_name)
  return _s;
}
...
inline std::string* VerifyConnectRequest::release_server_name() {
  // @@protoc_insertion_point(field_release:sro.gamebackend.VerifyConnectRequest.server_name)
...
inline void VerifyConnectRequest::set_allocated_server_name(std::string* value) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:sro.gamebackend.VerifyConnectRequest.server_name)
}
...
inline bool ConnectionStatus::online() const {
  // @@protoc_insertion_point(field_get:sro.gamebackend.ConnectionStatus.online)
  return _internal_online();
}
inline void ConnectionStatus::set_online(bool value) {
  _internal_set_online(value);
  // @@protoc_insertion_point(field_set:sro.gamebackend.ConnectionStatus.online)
}
...
inline const std::string& TransferPlayerRequest::character() const {
  // @@protoc_insertion_point(field_get:sro.gamebackend.TransferPlayerRequest.character)
...
inline PROTOBUF_ALWAYS_INLINE void TransferPlayerRequest::set_character(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:sro.gamebackend.TransferPlayerRequest.character)
}
inline std::string* TransferPlayerRequest::mutable_character() {
  std::string* _s = _internal_mutable_character();
  // @@protoc_insertion_point(field_mutable:sro.gamebackend.TransferPlayerRequest.character)
  return _s;
}
...
inline std::string* TransferPlayerRequest::release_character() {
  // @@protoc_insertion_point(field_release:sro.gamebackend.TransferPlayerRequest.character)
...
inline void TransferPlayerRequest::set_allocated_character(std::string* value) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:sro.gamebackend.TransferPlayerRequest.character)
}
...
inline const ::sro::Location& TransferPlayerRequest::location() const {
  // @@protoc_insertion_point(field_get:sro.gamebackend.TransferPlayerRequest.location)
...
inline void TransferPlayerRequest::unsafe_arena_set_allocated_location(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:sro.gamebackend.TransferPlayerRequest.location)
}
...
inline ::sro::Location* TransferPlayerRequest::unsafe_arena_release_location() {
  // @@protoc_insertion_point(field_release:sro.gamebackend.TransferPlayerRequest.location)
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::sro::Location* temp = _impl_.location_;
  _impl_.location_ = nullptr;
  return temp;
...
inline ::sro::Location* TransferPlayerRequest::mutable_location() {
  ...
  // @@protoc_insertion_point(field_mutable:sro.gamebackend.TransferPlayerRequest.location)
  return _msg;
}
inline void TransferPlayerRequest::set_allocated_location(::sro::Location* location) {
  ...
  _impl_.location_ = location;
  // @@protoc_insertion_point(field_set_allocated:sro.gamebackend.TransferPlayerRequest.location)
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_sro_2fgamebackend_2fconnection_2eproto_2epb_2eh

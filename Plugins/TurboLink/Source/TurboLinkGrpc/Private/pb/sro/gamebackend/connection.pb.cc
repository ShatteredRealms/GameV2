...
static ::_pb::Metadata file_level_metadata_sro_2fgamebackend_2fconnection_2eproto[4];
static constexpr const ::_pb::EnumDescriptor**
    file_level_enum_descriptors_sro_2fgamebackend_2fconnection_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_sro_2fgamebackend_2fconnection_2eproto = nullptr;
const ::uint32_t TableStruct_sro_2fgamebackend_2fconnection_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
    ...
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::sro::gamebackend::ConnectGameServerResponse, _impl_.address_),
    PROTOBUF_FIELD_OFFSET(::sro::gamebackend::ConnectGameServerResponse, _impl_.port_),
    PROTOBUF_FIELD_OFFSET(::sro::gamebackend::ConnectGameServerResponse, _impl_.connection_id_),
    ~0u,  // no _has_bits_
    PROTOBUF_FIELD_OFFSET(::sro::gamebackend::VerifyConnectRequest, _internal_metadata_),
    ~0u,  // no _extensions_
    ~0u,  // no _oneof_case_
    ~0u,  // no _weak_field_map_
    ~0u,  // no _inlined_string_donated_
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::sro::gamebackend::VerifyConnectRequest, _impl_.connection_id_),
    PROTOBUF_FIELD_OFFSET(::sro::gamebackend::VerifyConnectRequest, _impl_.server_name_),
    ~0u,  // no _has_bits_
    PROTOBUF_FIELD_OFFSET(::sro::gamebackend::ConnectionStatus, _internal_metadata_),
    ~0u,  // no _extensions_
    ~0u,  // no _oneof_case_
    ~0u,  // no _weak_field_map_
    ~0u,  // no _inlined_string_donated_
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::sro::gamebackend::ConnectionStatus, _impl_.online_),
    PROTOBUF_FIELD_OFFSET(::sro::gamebackend::TransferPlayerRequest, _impl_._has_bits_),
    PROTOBUF_FIELD_OFFSET(::sro::gamebackend::TransferPlayerRequest, _internal_metadata_),
    ~0u,  // no _extensions_
    ~0u,  // no _oneof_case_
    ~0u,  // no _weak_field_map_
    ~0u,  // no _inlined_string_donated_
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::sro::gamebackend::TransferPlayerRequest, _impl_.character_),
    PROTOBUF_FIELD_OFFSET(::sro::gamebackend::TransferPlayerRequest, _impl_.location_),
    ~0u,
    0,
};
...
static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        ...
        { 11, -1, -1, sizeof(::sro::gamebackend::VerifyConnectRequest)},
        { 21, -1, -1, sizeof(::sro::gamebackend::ConnectionStatus)},
        { 30, 40, -1, sizeof(::sro::gamebackend::TransferPlayerRequest)},
};

static const ::_pb::Message* const file_default_instances[] = {
    &::sro::gamebackend::_ConnectGameServerResponse_default_instance_._instance,
    &::sro::gamebackend::_VerifyConnectRequest_default_instance_._instance,
    &::sro::gamebackend::_ConnectionStatus_default_instance_._instance,
    &::sro::gamebackend::_TransferPlayerRequest_default_instance_._instance,
};
const char descriptor_table_protodef_sro_2fgamebackend_2fconnection_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    ...
    "o\032\035sro/character/character.proto\032\021sro/gl"
    "obals.proto\"Q\n\031ConnectGameServerResponse"
    "\022\017\n\007address\030\001 \001(\t\022\014\n\004port\030\002 \001(\r\022\025\n\rconne"
    "ction_id\030\003 \001(\t\"B\n\024VerifyConnectRequest\022\025"
    "\n\rconnection_id\030\001 \001(\t\022\023\n\013server_name\030\002 \001"
    "(\t\"\"\n\020ConnectionStatus\022\016\n\006online\030\001 \001(\010\"K"
    "\n\025TransferPlayerRequest\022\021\n\tcharacter\030\001 \001"
    "(\t\022\037\n\010location\030\002 \001(\0132\r.sro.Location2\323\004\n\021"
    "ConnectionService\022\253\001\n\021ConnectGameServer\022"
    "\036.sro.character.CharacterTarget\032*.sro.ga"
    "mebackend.ConnectGameServerResponse\"J\202\323\344"
    "\223\002D\022\035/v1/connect/character/id/{id}Z#\022!/v"
    "1/connect/character/name/{name}\022v\n\rVerif"
    "yConnect\022%.sro.gamebackend.VerifyConnect"
    "Request\032\037.sro.character.CharacterDetails"
    "\"\035\202\323\344\223\002\027\"\022/v1/connect/verify:\001*\022}\n\016Trans"
    "ferPlayer\022&.sro.gamebackend.TransferPlay"
    "erRequest\032*.sro.gamebackend.ConnectGameS"
    "erverResponse\"\027\202\323\344\223\002\021\"\014/v1/transfer:\001*\022\230"
    "\001\n\tIsPlaying\022\036.sro.character.CharacterTa"
    "rget\032!.sro.gamebackend.ConnectionStatus\""
    "H\202\323\344\223\002B\022\034/v1/status/character/id/{id}Z\"\022"
    " /v1/status/character/name/{name}B\010Z\006pkg"
    "/pbb\006proto3"
};
static const ::_pbi::DescriptorTable* const descriptor_table_sro_2fgamebackend_2fconnection_2eproto_deps[3] =
    {
        &::descriptor_table_google_2fapi_2fannotations_2eproto,
        &::descriptor_table_sro_2fcharacter_2fcharacter_2eproto,
        &::descriptor_table_sro_2fglobals_2eproto,
};
static ::absl::once_flag descriptor_table_sro_2fgamebackend_2fconnection_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_sro_2fgamebackend_2fconnection_2eproto = {
    false,
    false,
    1011,
    descriptor_table_protodef_sro_2fgamebackend_2fconnection_2eproto,
    "sro/gamebackend/connection.proto",
    &descriptor_table_sro_2fgamebackend_2fconnection_2eproto_once,
    descriptor_table_sro_2fgamebackend_2fconnection_2eproto_deps,
    3,
    4,
    schemas,
    file_default_instances,
    TableStruct_sro_2fgamebackend_2fconnection_2eproto::offsets,
    file_level_metadata_sro_2fgamebackend_2fconnection_2eproto,
    file_level_enum_descriptors_sro_2fgamebackend_2fconnection_2eproto,
    file_level_service_descriptors_sro_2fgamebackend_2fconnection_2eproto,
};
...
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_sro_2fgamebackend_2fconnection_2eproto_getter() {
  return &descriptor_table_sro_2fgamebackend_2fconnection_2eproto;
}
// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_sro_2fgamebackend_2fconnection_2eproto(&descriptor_table_sro_2fgamebackend_2fconnection_2eproto);
namespace sro {
namespace gamebackend {
// ===================================================================
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "sro.gamebackend.ConnectGameServerResponse.address"));
        } else {
          goto handle_unusual;
        }
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 26)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "sro.gamebackend.ConnectGameServerResponse.connection_id"));
        } else {
          goto handle_unusual;
        }
        continue;
...
::uint8_t* ConnectGameServerResponse::_InternalSerialize(
  ...
  if (!this->_internal_address().empty()) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "sro.gamebackend.ConnectGameServerResponse.address");
  ...
  if (!this->_internal_connection_id().empty()) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "sro.gamebackend.ConnectGameServerResponse.connection_id");
...
VerifyConnectRequest::VerifyConnectRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:sro.gamebackend.VerifyConnectRequest)
}
VerifyConnectRequest::VerifyConnectRequest(const VerifyConnectRequest& from)
  ...
  // @@protoc_insertion_point(copy_constructor:sro.gamebackend.VerifyConnectRequest)
}
...
VerifyConnectRequest::~VerifyConnectRequest() {
  // @@protoc_insertion_point(destructor:sro.gamebackend.VerifyConnectRequest)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
// @@protoc_insertion_point(message_clear_start:sro.gamebackend.VerifyConnectRequest)
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "sro.gamebackend.VerifyConnectRequest.connection_id"));
        } else {
          goto handle_unusual;
        }
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "sro.gamebackend.VerifyConnectRequest.server_name"));
        } else {
          goto handle_unusual;
        }
        continue;
...
::uint8_t* VerifyConnectRequest::_InternalSerialize(
    ::uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:sro.gamebackend.VerifyConnectRequest)
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_connection_id().empty()) {
    const std::string& _s = this->_internal_connection_id();
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "sro.gamebackend.VerifyConnectRequest.connection_id");
    target = stream->WriteStringMaybeAliased(1, _s, target);
  }
  ...
  if (!this->_internal_server_name().empty()) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "sro.gamebackend.VerifyConnectRequest.server_name");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:sro.gamebackend.VerifyConnectRequest)
  return target;
}

::size_t VerifyConnectRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:sro.gamebackend.VerifyConnectRequest)
  ::size_t total_size = 0;
...
void VerifyConnectRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:sro.gamebackend.VerifyConnectRequest)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:sro.gamebackend.VerifyConnectRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata VerifyConnectRequest::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_sro_2fgamebackend_2fconnection_2eproto_getter, &descriptor_table_sro_2fgamebackend_2fconnection_2eproto_once,
      file_level_metadata_sro_2fgamebackend_2fconnection_2eproto[1]);
}
// ===================================================================
...
ConnectionStatus::ConnectionStatus(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:sro.gamebackend.ConnectionStatus)
}
ConnectionStatus::ConnectionStatus(const ConnectionStatus& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(), _impl_(from._impl_) {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(
      from._internal_metadata_);
  // @@protoc_insertion_point(copy_constructor:sro.gamebackend.ConnectionStatus)
}
...
ConnectionStatus::~ConnectionStatus() {
  // @@protoc_insertion_point(destructor:sro.gamebackend.ConnectionStatus)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
// @@protoc_insertion_point(message_clear_start:sro.gamebackend.ConnectionStatus)
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::uint8_t* ConnectionStatus::_InternalSerialize(
    ::uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:sro.gamebackend.ConnectionStatus)
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:sro.gamebackend.ConnectionStatus)
  return target;
}

::size_t ConnectionStatus::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:sro.gamebackend.ConnectionStatus)
  ::size_t total_size = 0;
...
void ConnectionStatus::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:sro.gamebackend.ConnectionStatus)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:sro.gamebackend.ConnectionStatus)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata ConnectionStatus::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_sro_2fgamebackend_2fconnection_2eproto_getter, &descriptor_table_sro_2fgamebackend_2fconnection_2eproto_once,
      file_level_metadata_sro_2fgamebackend_2fconnection_2eproto[2]);
}
// ===================================================================
...
TransferPlayerRequest::TransferPlayerRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:sro.gamebackend.TransferPlayerRequest)
}
TransferPlayerRequest::TransferPlayerRequest(const TransferPlayerRequest& from)
  ...
  // @@protoc_insertion_point(copy_constructor:sro.gamebackend.TransferPlayerRequest)
}
...
TransferPlayerRequest::~TransferPlayerRequest() {
  // @@protoc_insertion_point(destructor:sro.gamebackend.TransferPlayerRequest)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
// @@protoc_insertion_point(message_clear_start:sro.gamebackend.TransferPlayerRequest)
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "sro.gamebackend.TransferPlayerRequest.character"));
        } else {
          goto handle_unusual;
        }
        continue;
...
::uint8_t* TransferPlayerRequest::_InternalSerialize(
    ::uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:sro.gamebackend.TransferPlayerRequest)
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_character().empty()) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "sro.gamebackend.TransferPlayerRequest.character");
    target = stream->WriteStringMaybeAliased(1, _s, target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:sro.gamebackend.TransferPlayerRequest)
  return target;
}

::size_t TransferPlayerRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:sro.gamebackend.TransferPlayerRequest)
  ::size_t total_size = 0;
...
void TransferPlayerRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:sro.gamebackend.TransferPlayerRequest)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:sro.gamebackend.TransferPlayerRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata TransferPlayerRequest::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_sro_2fgamebackend_2fconnection_2eproto_getter, &descriptor_table_sro_2fgamebackend_2fconnection_2eproto_once,
      file_level_metadata_sro_2fgamebackend_2fconnection_2eproto[3]);
}
// @@protoc_insertion_point(namespace_scope)
}  // namespace gamebackend
}  // namespace sro
PROTOBUF_NAMESPACE_OPEN
template<> PROTOBUF_NOINLINE ::sro::gamebackend::ConnectGameServerResponse*
Arena::CreateMaybeMessage< ::sro::gamebackend::ConnectGameServerResponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::sro::gamebackend::ConnectGameServerResponse >(arena);
}
template<> PROTOBUF_NOINLINE ::sro::gamebackend::VerifyConnectRequest*
Arena::CreateMaybeMessage< ::sro::gamebackend::VerifyConnectRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::sro::gamebackend::VerifyConnectRequest >(arena);
}
template<> PROTOBUF_NOINLINE ::sro::gamebackend::ConnectionStatus*
Arena::CreateMaybeMessage< ::sro::gamebackend::ConnectionStatus >(Arena* arena) {
  return Arena::CreateMessageInternal< ::sro::gamebackend::ConnectionStatus >(arena);
}
template<> PROTOBUF_NOINLINE ::sro::gamebackend::TransferPlayerRequest*
Arena::CreateMaybeMessage< ::sro::gamebackend::TransferPlayerRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::sro::gamebackend::TransferPlayerRequest >(arena);
}

...
static const char* ChatService_method_names[] = {
  ...
  "/sro.chat.ChatService/SetUserChatChannelAuthorizations",
};
...
ChatService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_SetUserChatChannelAuthorizations_(ChatService_method_names[11], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::ClientReader< ::sro::chat::ChatMessage>* ChatService::Stub::ConnectDirectMessageRaw(::grpc::ClientContext* context, const ::sro::character::CharacterTarget& request) {
...
void ChatService::Stub::async::ConnectDirectMessage(::grpc::ClientContext* context, const ::sro::character::CharacterTarget* request, ::grpc::ClientReadReactor< ::sro::chat::ChatMessage>* reactor) {
...
::grpc::ClientAsyncReader< ::sro::chat::ChatMessage>* ChatService::Stub::AsyncConnectDirectMessageRaw(::grpc::ClientContext* context, const ::sro::character::CharacterTarget& request, ::grpc::CompletionQueue* cq, void* tag) {
...
::grpc::ClientAsyncReader< ::sro::chat::ChatMessage>* ChatService::Stub::PrepareAsyncConnectDirectMessageRaw(::grpc::ClientContext* context, const ::sro::character::CharacterTarget& request, ::grpc::CompletionQueue* cq) {
...
::grpc::Status ChatService::Stub::GetAuthorizedChatChannels(::grpc::ClientContext* context, const ::sro::character::CharacterTarget& request, ::sro::chat::ChatChannels* response) {
  return ::grpc::internal::BlockingUnaryCall< ::sro::character::CharacterTarget, ::sro::chat::ChatChannels, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_GetAuthorizedChatChannels_, context, request, response);
}

void ChatService::Stub::async::GetAuthorizedChatChannels(::grpc::ClientContext* context, const ::sro::character::CharacterTarget* request, ::sro::chat::ChatChannels* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::sro::character::CharacterTarget, ::sro::chat::ChatChannels, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_GetAuthorizedChatChannels_, context, request, response, std::move(f));
}

void ChatService::Stub::async::GetAuthorizedChatChannels(::grpc::ClientContext* context, const ::sro::character::CharacterTarget* request, ::sro::chat::ChatChannels* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::sro::chat::ChatChannels>* ChatService::Stub::PrepareAsyncGetAuthorizedChatChannelsRaw(::grpc::ClientContext* context, const ::sro::character::CharacterTarget& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::sro::chat::ChatChannels, ::sro::character::CharacterTarget, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_GetAuthorizedChatChannels_, context, request);
}

::grpc::ClientAsyncResponseReader< ::sro::chat::ChatChannels>* ChatService::Stub::AsyncGetAuthorizedChatChannelsRaw(::grpc::ClientContext* context, const ::sro::character::CharacterTarget& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
::grpc::Status ChatService::Stub::SetUserChatChannelAuthorizations(::grpc::ClientContext* context, const ::sro::chat::RequestSetChannelAuth& request, ::google::protobuf::Empty* response) {
  return ::grpc::internal::BlockingUnaryCall< ::sro::chat::RequestSetChannelAuth, ::google::protobuf::Empty, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_SetUserChatChannelAuthorizations_, context, request, response);
}

void ChatService::Stub::async::SetUserChatChannelAuthorizations(::grpc::ClientContext* context, const ::sro::chat::RequestSetChannelAuth* request, ::google::protobuf::Empty* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::sro::chat::RequestSetChannelAuth, ::google::protobuf::Empty, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_SetUserChatChannelAuthorizations_, context, request, response, std::move(f));
}

void ChatService::Stub::async::SetUserChatChannelAuthorizations(::grpc::ClientContext* context, const ::sro::chat::RequestSetChannelAuth* request, ::google::protobuf::Empty* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_SetUserChatChannelAuthorizations_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::google::protobuf::Empty>* ChatService::Stub::PrepareAsyncSetUserChatChannelAuthorizationsRaw(::grpc::ClientContext* context, const ::sro::chat::RequestSetChannelAuth& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::google::protobuf::Empty, ::sro::chat::RequestSetChannelAuth, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_SetUserChatChannelAuthorizations_, context, request);
}

::grpc::ClientAsyncResponseReader< ::google::protobuf::Empty>* ChatService::Stub::AsyncSetUserChatChannelAuthorizationsRaw(::grpc::ClientContext* context, const ::sro::chat::RequestSetChannelAuth& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncSetUserChatChannelAuthorizationsRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
ChatService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::SERVER_STREAMING,
      new ::grpc::internal::ServerStreamingHandler< ChatService::Service, ::sro::character::CharacterTarget, ::sro::chat::ChatMessage>(
          [](ChatService::Service* service,
             ::grpc::ServerContext* ctx,
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< ChatService::Service, ::sro::character::CharacterTarget, ::sro::chat::ChatChannels, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](ChatService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::sro::character::CharacterTarget* req,
             ::sro::chat::ChatChannels* resp) {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< ChatService::Service, ::sro::chat::RequestSetChannelAuth, ::google::protobuf::Empty, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](ChatService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::sro::chat::RequestSetChannelAuth* req,
             ::google::protobuf::Empty* resp) {
               return service->SetUserChatChannelAuthorizations(ctx, req, resp);
             }, this)));
}
...
::grpc::Status ChatService::Service::ConnectDirectMessage(::grpc::ServerContext* context, const ::sro::character::CharacterTarget* request, ::grpc::ServerWriter< ::sro::chat::ChatMessage>* writer) {
  (void) context;
  (void) request;
  (void) writer;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status ChatService::Service::GetAuthorizedChatChannels(::grpc::ServerContext* context, const ::sro::character::CharacterTarget* request, ::sro::chat::ChatChannels* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status ChatService::Service::SetUserChatChannelAuthorizations(::grpc::ServerContext* context, const ::sro::chat::RequestSetChannelAuth* request, ::google::protobuf::Empty* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");

...
void UCharacterService::CallGetCharacters(const FGrpcGoogleProtobufEmpty& Request, FGetCharactersResponseLambda ResponseLambda, TMap<FString, FString>& MetaData)
{
...
void UCharacterService::CallGetCharacter(const FGrpcSroCharacterCharacterTarget& Request, FGetCharacterResponseLambda ResponseLambda, TMap<FString, FString>& MetaData)
{
	if (InnerClient == nullptr)
	{
		InnerClient = MakeClient();
...
void UCharacterService::CallDeleteCharacter(const FGrpcSroCharacterCharacterTarget& Request, FDeleteCharacterResponseLambda ResponseLambda, TMap<FString, FString>& MetaData)
{
	if (InnerClient == nullptr)
	{
		InnerClient = MakeClient();
...
void UCharacterService::CallGetAllCharactersForUser(const FGrpcSroUserTarget& Request, FGetAllCharactersForUserResponseLambda ResponseLambda, TMap<FString, FString>& MetaData)
{
	if (InnerClient == nullptr)
	{
		InnerClient = MakeClient();
	}
	UCharacterServiceGetAllCharactersForUserLambdaWrapper* lambdaWrapper = NewObject<UCharacterServiceGetAllCharactersForUserLambdaWrapper>();
	lambdaWrapper->InnerClient = InnerClient;
	lambdaWrapper->ResponseLambda = ResponseLambda;
	lambdaWrapper->Handle = InnerClient->InitGetAllCharactersForUser();
	InnerClient->OnGetAllCharactersForUserResponse.AddUniqueDynamic(lambdaWrapper, &UCharacterServiceGetAllCharactersForUserLambdaWrapper::OnResponse);
	InnerClient->GetAllCharactersForUser(lambdaWrapper->Handle, Request, MetaData);
}
...
void UCharacterService::CallGetInventory(const FGrpcSroCharacterCharacterTarget& Request, FGetInventoryResponseLambda ResponseLambda, TMap<FString, FString>& MetaData)
{
	if (InnerClient == nullptr)
	{
		InnerClient = MakeClient();
	}
	UCharacterServiceGetInventoryLambdaWrapper* lambdaWrapper = NewObject<UCharacterServiceGetInventoryLambdaWrapper>();
	lambdaWrapper->InnerClient = InnerClient;
	lambdaWrapper->ResponseLambda = ResponseLambda;
	lambdaWrapper->Handle = InnerClient->InitGetInventory();
	InnerClient->OnGetInventoryResponse.AddUniqueDynamic(lambdaWrapper, &UCharacterServiceGetInventoryLambdaWrapper::OnResponse);
	InnerClient->GetInventory(lambdaWrapper->Handle, Request, MetaData);
}

void UCharacterService::CallSetInventory(const FGrpcSroCharacterUpdateInventoryRequest& Request, FSetInventoryResponseLambda ResponseLambda, TMap<FString, FString>& MetaData)
{
	if (InnerClient == nullptr)
	{
		InnerClient = MakeClient();
	}
	UCharacterServiceSetInventoryLambdaWrapper* lambdaWrapper = NewObject<UCharacterServiceSetInventoryLambdaWrapper>();
	lambdaWrapper->InnerClient = InnerClient;
	lambdaWrapper->ResponseLambda = ResponseLambda;
	lambdaWrapper->Handle = InnerClient->InitSetInventory();
	InnerClient->OnSetInventoryResponse.AddUniqueDynamic(lambdaWrapper, &UCharacterServiceSetInventoryLambdaWrapper::OnResponse);
	InnerClient->SetInventory(lambdaWrapper->Handle, Request, MetaData);
}
